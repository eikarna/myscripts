...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone()
 {
	...
	then
                mkdir clang-llvm
		wget https://github.com/ZyCromerZ/Clang/releases/download/18.0.0-20231026-release/Clang-18.0.0-20231026.tar.gz -O "Clang-18.0.0-20231026.tar.gz"
                tar -xf Clang-18.0.0-20231026.tar.gz -C clang-llvm
